package com.adjadev.stock.services.auth;
...
import com.adjadev.stock.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
       var user = Utilisateur.builder()
                ...
                .motPasse(passwordEncoder.encode(request.getPassword()))
                .role(Role.USER)
                .build();
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        var user = repository.findUtilisateurByEmail(request.getEmail())
                .orElseThrow();
        var jwtToken = jwtService.generateToken(user);
        var refreshToken = jwtService.generateRefreshToken(user);
    ...
    public void refreshToken(
        ...
        if (userEmail != null) {
            var user = this.repository.findUtilisateurByEmail(userEmail)
                    .orElseThrow();
